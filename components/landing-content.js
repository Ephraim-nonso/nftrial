    ...
    <Container>
      <div className="flex flex-col order-2 xl:order-none xl:flex-row justify-between items-center w-full xl:pr-12">
        ...
        <div className="w-full xl:max-w-[46%] flex flex-col items-center xl:items-start space-y-7 xl:space-y-14 justify-center">
          ...
          <Link href="/gamescreen" passHref={true} className="no-underline ">
            <div className="w-56 h-16 xl:w-80 xl:h-20 flex bg-white items-center cursor-pointer space-x-7 justify-center font-normal text-2xl leading-6  xl:text-4xl xl:leading-[45px] ">
              <p>DISCOVER</p>
