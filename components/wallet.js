  ...
  return (
    <React.Fragment>
        ...
        <Link href="/" passHref={true}>
          ...
          <h4 className="sm:text-2xl font-grotesk text-left text-white md:font-normal md:text-5xl">Connect your wallet to log in</h4>
        </div>
        <div className="sm:grid  p-4  md:grid grid-cols-2 gap-8 ">
          <div className="mb-4 bg-slate-50 rounded-lg flex items-center justify-between p-4">
            <div className="flex  items-center ">
              <Image src="/assets/walletConnect-icon.svg" width={100} height={100} />
              <h4 className="ml-4 font-grotesk font-normal text-2xl">walletconnects</h4>
            </div>
            <button><BsArrowRight font-size={35} /></button>
          </div>
          <div className="mb-4 bg-slate-50 rounded-lg flex items-center justify-between p-4">
            <div className="flex  items-center">
          ...
          <div className="mb-4 bg-slate-50 rounded-lg flex items-center justify-between p-4">
            <div className="flex  items-center">
              ...
              <h4 className="ml-4 font-grotesk font-normal text-2xl">trust Wallet</h4>
            </div>
            <button><BsArrowRight font-size={35} /></button>
          </div>
          <div className="mb-4 bg-slate-50 rounded-lg flex items-center justify-between p-4">
