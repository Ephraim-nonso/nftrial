  ...
  return (
    <div className="my-5">
      <div className="flex my-8">
        <div
          className="h-24  p-7 cursor-pointer max-w-sm md:max-w-lg item-center justify-center mx-1 bg-slate-400 shadow-lg "
          onClick={() => {
            alert();
          }}
        >
        ...
        <div
          className="h-24  p-7 cursor-pointer max-w-sm md:max-w-lg  mx-1 bg-slate-400 shadow-lg "
          onClick={() => {
            alert();
          }}
        >
      ...
      <div className="flex my-7">
        <div
          className="h-24 w-18  p-7 cursor-pointer max-w-sm md:max-w-lg  mx-1 bg-slate-400 shadow-lg "
          onClick={() => {
            alert();
          }}
        >
